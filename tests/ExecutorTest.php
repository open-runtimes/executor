...
final class ExecutorTest extends TestCase
{
    ...
    {
        Co\run(function () use (&$runtimeStdout, &$runtimeStderr) {
            $runtimeStdout = '';
            $runtimeStderr = '';
            ...
            Co::join([
                ...
                /** Start runtime */
                Co\go(function () use (&$runtimeStdout, &$runtimeStderr) {
                    $params = [
                    ...
                    $runtimeStdout = $response['body']['stdout'];
                    $runtimeStderr = $response['body']['stderr'];
                }),
            ]);
